...
SECRET_KEY = 'django-insecure-6sbqw-qz3-bnm+0v3c4(7$vc!u(%op*-_#)4e3tq@fi7nbr0i%'
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "Nookat-bilimkana.kg",
    ...
    "site_logo": os.path.join('img', 'logo2.gif'),
    ...
    "welcome_sign": _("Добро пожаловать в администрацию сайта"),
    ...
    "topmenu_links": [
        ...
        {"name": _("Открыть сайт"), "url": "/", "permissions": ["auth.view_user"]},
    ...
    "icons": {
        ...
        "core.Slaids": "fab fa-slideshare",
        "core.Partners": "fas fa-handshake",
        "core.Images": "fas fa-file-image",
        "core.Gallery": "fas fa-images",
        "core.Menus": "fas fa-bars",
        "core.Comments": "fas fa-comment",
        "core.Attributes": "fas fa-cubes",
        "core.Categories": "fas fa-quote-left",
        "core.Links": "fas fa-link",
    },
    ...
    "custom_css": None,
    "custom_js": os.path.join('js', 'script.js'),
